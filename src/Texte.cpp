...
#ifdef DINGUX
        case 103 : texte = "Tip : Hold R to look around with the D-Pad."; break;
#else
...
#ifdef DINGUX
        case 132 : texte = "You find the Map!!!*Press X to see the map of the Dungeon."; break;
#else
...
#ifdef DINGUX
        case 289 : texte = "You just have to beat a new enemy to add him in the encyclopedia.*You can see it by pressing L!"; break;
#else
...
#ifdef DINGUX
        case 394 : texte = "As Oni-Link, you cannot use objects, but you can teleport yourself to the entry when you are in a dungeon by pressing R."; idsuiv=395; break;
#else
...
#ifdef DINGUX
        case 401 : texte = "You find the Termina map!!!**Press X when you are outside to see it."; break;
#else
